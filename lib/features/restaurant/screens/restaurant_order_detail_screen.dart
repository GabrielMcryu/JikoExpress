...
import 'package:jiko_express/features/restaurant/screens/restaurant_assign_rider_screen.dart';

class RestaurantOrderDetailsScreen extends StatefulWidget {
  static const String routeName = '/restaurant-order-details';
  final Order order;
  const RestaurantOrderDetailsScreen({super.key, required this.order});
...
class _RestaurantOrderDetailsScreenState extends State<RestaurantOrderDetailsScreen> {
  ...
  void navigateToAssignRider(BuildContext context, String orderId) {
    Navigator.pushNamed(context, RestaurantAssignRiderScreen.routeName,arguments: orderId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: widget.order.status == 0
          ? FloatingActionButton(
            onPressed: () {
              navigateToAssignRider(context, widget.order.id);
            },
            tooltip: 'Assign a Rider',
